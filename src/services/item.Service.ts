// item repo methods
import {createItem , findItem , findItems , updateItem , deleteItem} from '../repositories/item.Repo';


export const CreateItemService = async({ name, catalogId, categoryId , quantity , price }:Omit<Item,"id">) => {
